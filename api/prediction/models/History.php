...
class History {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . " (ClientName, Date, DeviceType, CPUUsage, RAMUsage, Temperature, Voltage, DiskUsage, FanSpeed, ConclusionId, VerifiedByUser) 
        VALUES 
        (:clientName, :date, :deviceType, :CPUUsage, :RAMUsage, :temperature, :voltage, :diskUsage, :fanSpeed, :conclusionId, :verifiedByUser)";
