...
require_once 'prediction\controllers\Predict.php';
require_once 'prediction\controllers\GetAllHistory.php';
require_once 'prediction\models\Conclusion.php';
require_once 'prediction\models\History.php';
require_once 'prediction\requests\PredictRequest.php';
